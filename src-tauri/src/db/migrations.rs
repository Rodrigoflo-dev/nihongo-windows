...
const MIGRATIONS: &[(u32, &str, &str)] = &[
    ...
    (
        16,
        "016_store_themes",
        include_str!("../../migrations/016_store_themes.sql"),
    ),
    (
        17,
        "017_more_themes",
        include_str!("../../migrations/017_more_themes.sql"),
    ),
    (
        18,
        "018_cosmetics",
        include_str!("../../migrations/018_cosmetics.sql"),
    ),
    (
        19,
        "019_theme_prices",
        include_str!("../../migrations/019_theme_prices.sql"),
    ),
    (
        20,
        "020_more_reading_listening",
        include_str!("../../migrations/020_more_reading_listening.sql"),
    ),
    (
        21,
        "021_n4_lessons",
        include_str!("../../migrations/021_n4_lessons.sql"),
    ),
    (
        22,
        "022_level_progression",
        include_str!("../../migrations/022_level_progression.sql"),
    ),
    (
        23,
        "023_n4_expansion",
        include_str!("../../migrations/023_n4_expansion.sql"),
    ),
    (
        24,
        "024_extend_demonstratives_yesno",
        include_str!("../../migrations/024_extend_demonstratives_yesno.sql"),
    ),
    (
        25,
        "025_days_complete",
        include_str!("../../migrations/025_days_complete.sql"),
    ),
];
